...
.home-buttons {
  ...
  gap: 0.75rem;
  background: #fffcbd; /* professional beige-gray tone */
...
/* mobile view: stack buttons neatly */
...
.icon-nav {
  ...
  justify-content: center;
  gap: 1.2rem;
  background: #e6ffd4;            /* beige background */
...
<div class="icon-nav">
  ...
  <a href="#vision" title="Vision"><i class="bi bi-lightbulb-fill"></i></a>
